        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h1 class="text-2xl font-semibold text-gray-700 dark:text-gray-300 mb-6">Edit Warehouse: {{ $warehouse->Name }}</h1>

                    <form action="{{ route('warehouse.update', $warehouse->id) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="flex items-center justify-end space-x-4">
                            <a href="{{ route('warehouse.index') }}" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100">
                                Cancel
                            </a>
                            <button type="submit"
